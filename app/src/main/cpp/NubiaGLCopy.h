...
Java_com_example_cameraxtest_GLCopyJni_initHardwareBuffer(
        JNIEnv*env, jclass type, jint, jint, jint);

JNIEXPORT void JNICALL
Java_com_example_cameraxtest_GLCopyJni_releaseHardwareBuffer(
        JNIEnv*env, jclass type, jlong handler);

JNIEXPORT jbyteArray JNICALL
Java_com_example_cameraxtest_GLCopyJni_getBuffer(
        JNIEnv*env, jclass type, jlong handler);

JNIEXPORT void JNICALL
Java_com_example_cameraxtest_GLCopyJni_setBuffer(
